            ...
            <Container spacing={'VerticalXXXL'}>
                ...
                <section>
                    <button className={`button ${button.primary}`}
                        onClick={() => window.location = 'mailto:brendan@tekahna.com'} >
                        {content.buttons.primary.title}
                    </button>
                    <button className={`button ${button.secondary} leaveSite`}
                        onClick={() => window.open("https://www.linkedin.com/in/brendanglancy/", "_blank")} >
                        {content.buttons.secondary.title}
                    </button>
                    <button className={`button ${button.github} leaveSite`}
                        onClick={() => window.open("https://github.com/brendanglancy", "_blank")} >
