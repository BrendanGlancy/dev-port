...
var Module = function() {
    ...
    return function(Module1) {
        ...
        var A, ja = !1, ka = new _textDecoder.TextDecoder('utf8');
        function la(a, b, c) {
            var d = B;
            if (0 < c) {
                c = b + c - 1;
        ...
        var ma = new _textDecoder.TextDecoder('utf-16le');
        function na(a, b) {
            var c = a >> 1;
        ...
        function Ta(a, b, c) {
            f.hasOwnProperty(a) ? ((void 0 === c || void 0 !== f[a].F && void 0 !== f[a].F[c]) && W("Cannot register public name '" + a + "' twice"), Sa(a, a), f.hasOwnProperty(c) && W('Cannot register multiple overloads of a function with the same number of arguments (' + c + ')!'), f[a].F[c] = b) : (f[a] = b, void 0 !== c && (f[a].X = c));
        }
        function Ua(a, b, c) {
            switch(b){
                case 0:
        ...
        for(var ib = Array(256), jb = 0; 256 > jb; ++jb)ib[jb] = String.fromCharCode(jb);
        Na = ib;
        ...
        var mb = {
            ...
            m: function(a) {
                var b = O[a];
                delete O[a];
                var c = b.R, d = b.S, e = b.I, g = e.map(function(l) {
                    return l.O;
                ...
                La([
                    ...
                    e.forEach(function(k, m) {
                        var n = l[m], q = k.M, w = k.N, x = l[m + e.length], p = k.T, da = k.V;
                        h[k.K] = {
                            read: function(y) {
            ...
            k: function(a, b, c) {
                ...
                U(a, {
                    ...
                    toWireType: function(d, e) {
                        if ('number' !== typeof e && 'boolean' !== typeof e) throw new TypeError('Cannot convert "' + Ya(e) + '" to ' + this.name);
                        return e;
                    },
                    argPackAdvance: 8,
            ...
            i: function(a, b, c, d, e, g) {
                ...
                La([], l, function(h) {
                    var k = [
                        h[0],
                        null
                    ].concat(h.slice(1)), m = h = a, n = e, q = k.length;
                    2 > q && W("argTypes array size mismatch! Must at least get return value and 'this' types!");
                    for(var w = null !== k[1] && !1, x = !1, p = 1; p < k.length; ++p)if (null !== k[p] && void 0 === k[p].D) {
                        x = !0;
                        break;
                    }
                    var da = 'void' !== k[0].name, y = '', E = '';
                    for(p = 0; p < q - 2; ++p)y += (0 !== p ? ', ' : '') + 'arg' + p, E += (0 !== p ? ', ' : '') + 'arg' + p + 'Wired';
                    m = 'return function ' + Ha(m) + '(' + y + ') {\nif (arguments.length !== ' + (q - 2) + ") {\nthrowBindingError('function " + m + " called with ' + arguments.length + ' arguments, expected " + (q - 2) + " args!');\n}\n";
                    x && (m += 'var destructors = [];\n');
            ...
            d: function(a, b, c, d, e) {
                ...
                U(a, {
                    ...
                    toWireType: function(m, n) {
                        if ('number' !== typeof n && 'boolean' !== typeof n) throw new TypeError('Cannot convert "' + Ya(n) + '" to ' + this.name);
                        if (n < d || n > e) throw new TypeError('Passing a number "' + Ya(n) + '" from JS side to C/C++ side to an argument of type "' + b + '", which is outside the valid range [' + d + ', ' + e + ']!');
                        return k ? n >>> 0 : n | 0;
                    },
                    argPackAdvance: 8,
                ...
                U(a, {
                    ...
                    toWireType: function(d, e) {
                        ...
                        if (c && g) la(e, h + 4, l + 1);
                            ...
                            255 < k && (Y(h), W('String has UTF-16 code units that do not fit in 8 bits'));
                            B[h + 4 + g] = k;
                        }
            ...
            h: function(a, b, c) {
                ...
                if (2 === b) {
                    ...
                    var h = 1;
                } else 4 === b && (d = qa, e = ra, g = sa, l = function() {
                    return I;
                }, h = 2);
                U(a, {
                    name: c,
                    fromWireType: function(k) {
                        for(var m = I[k >> 2], n = l(), q, w = k + 4, x = 0; x <= m; ++x){
                            var p = k + 4 + x * b;
                            if (x == m || 0 == n[p >> h]) w = d(w, p - w), void 0 === q ? q = w : (q += String.fromCharCode(0), q += w), w = p + b;
                        }
                        Y(k);
                        return q;
                    },
        ...
        (function() {
            function a(e) {
                ...
                0 == K && (null !== Ca && (clearInterval(Ca), Ca = null), L && (e = L, L = null, e()));
            }
            function b(e) {
                a(e.instance);
            }
            function c(e) {
                return Promise.resolve().then(Fa).then(function(g) {
            ...
            (function() {
                return z || 'function' !== typeof WebAssembly.instantiateStreaming || Da() || 'function' !== typeof fetch ? c(b) : fetch(M, {
        ...
        f.___embind_register_native_and_builtin_types = function() {
            return (f.___embind_register_native_and_builtin_types = f.asm.C).apply(null, arguments);
        };
        var nb;
        L = function ob() {
            nb || pb();
