...
var Module = function() {
    ...
    return function(Module1) {
        ...
        var B, fa = !1, ha = new _textDecoder.TextDecoder('utf8');
        function ia(a, b, c) {
            var d = C;
            if (0 < c) {
                c = b + c - 1;
        ...
        var ja = new _textDecoder.TextDecoder('utf-16le');
        function ka(a, b) {
            var c = a >> 1;
        ...
        function Ya(a, b) {
            0 <= a.indexOf('j') || x('Assertion failed: getDynCaller should only be called with i64 sigs');
            var c = [];
            return function() {
        ...
        var lb = {
            ...
            j: function(a, b, c, d, f, g) {
                ...
                La(l, function(h) {
                    ...
                    var Ma = 'void' !== k[0].name, H = '', K = '';
                    for(m = 0; m < q - 2; ++m)H += (0 !== m ? ', ' : '') + 'arg' + m, K += (0 !== m ? ', ' : '') + 'arg' + m + 'Wired';
                    n = 'return function ' + Ga(n) + '(' + H + ') {\nif (arguments.length !== ' + (q - 2) + ") {\nthrowBindingError('function " + n + " called with ' + arguments.length + ' arguments, expected " + (q - 2) + " args!');\n}\n";
                    A && (n += 'var destructors = [];\n');
            ...
            c: function(a, b, c, d, f) {
                ...
                U(a, {
                    ...
                    toWireType: function(n, p) {
                        if ('number' !== typeof p && 'boolean' !== typeof p) throw new TypeError('Cannot convert "' + Ra(p) + '" to ' + this.name);
                        if (p < d || p > f) throw new TypeError('Passing a number "' + Ra(p) + '" from JS side to C/C++ side to an argument of type "' + b + '", which is outside the valid range [' + d + ', ' + f + ']!');
                        return k ? p >>> 0 : p | 0;
                    },
                    argPackAdvance: 8,
            ...
            h: function(a, b, c) {
                ...
                U(a, {
                    ...
                    toWireType: function(k, n) {
                        'string' !== typeof n && T('Cannot pass non-string to C++ string type ' + c);
                        var p = g(n), q = kb(4 + p + b);
                        I[q >> 2] = p >> h;
                        f(n, q + 4, p + b);
                        null !== k && k.push(X, q);
                        return q;
        ...
        (function() {
            function a(f) {
                ...
                0 == L && (null !== Aa && (clearInterval(Aa), Aa = null), M && (f = M, M = null, f()));
            }
            function b(f) {
                a(f.instance);
            }
            ...
            (function() {
                return z || 'function' !== typeof WebAssembly.instantiateStreaming || Ba() || 'function' !== typeof fetch ? c(b) : fetch(N, {
