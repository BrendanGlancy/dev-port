...
var Module = function() {
    ...
    return function(Module1) {
        ...
        var ka = e.print || console.log.bind(console), w = e.printErr || console.warn.bind(console);
        ...
        var z, la = !1, ma = new _textDecoder.TextDecoder('utf8');
        function na(a, b, c) {
            var d = A;
            if (0 < c) {
                c = b + c - 1;
        ...
        var oa = new _textDecoder.TextDecoder('utf-16le');
        function pa(a, b) {
            var c = a >> 1;
        ...
        function Pa(a, b) {
            function c(h) {
                h = b(h);
                if (h.length !== d.length) throw new Oa('Mismatched type converter count');
        ...
        function $a(a, b, c) {
            e.hasOwnProperty(a) ? ((void 0 === c || void 0 !== e[a].G && void 0 !== e[a].G[c]) && T("Cannot register public name '" + a + "' twice"), Za(a, a), e.hasOwnProperty(c) && T('Cannot register multiple overloads of a function with the same number of arguments (' + c + ')!'), e[a].G[c] = b) : (e[a] = b, void 0 !== c && (e[a].O = c));
        }
        function ab(a, b) {
        ...
        function bb(a, b) {
            0 <= a.indexOf('j') || v('Assertion failed: getDynCaller should only be called with i64 sigs');
            var c = [];
            return function() {
                c.length = arguments.length;
                for(var d = 0; d < arguments.length; d++)c[d] = arguments[d];
                var f;
                -1 != a.indexOf('j') ? f = c && c.length ? e['dynCall_' + a].apply(null, [
                    b
                ].concat(c)) : e['dynCall_' + a].call(null, b) : f = J.get(b).apply(null, c);
                return f;
            };
        }
        function cb(a, b) {
        ...
        for(var ob, pb = [
            ...
            [],
            []
        ], qb = Array(256), Y = 0; 256 > Y; ++Y)qb[Y] = String.fromCharCode(Y);
        Ja = qb;
        ...
        var tb = {
            ...
            n: function(a, b, c) {
                ...
                U(a, {
                    ...
                    toWireType: function(d, f) {
                        if ('number' !== typeof f && 'boolean' !== typeof f) throw new TypeError('Cannot convert "' + Va(f) + '" to ' + this.name);
                        return f;
                    },
                    argPackAdvance: 8,
            ...
            q: function(a, b, c, d, f, g) {
                ...
                Pa(l, function(h) {
                    var k = [
                        h[0],
                        null
                    ].concat(h.slice(1)), m = h = a, n = f, p = k.length;
                    2 > p && T("argTypes array size mismatch! Must at least get return value and 'this' types!");
                    for(var x = null !== k[1] && !1, B = !1, q = 1; q < k.length; ++q)if (null !== k[q] && void 0 === k[q].H) {
                        B = !0;
                        break;
                    }
                    var Ta = 'void' !== k[0].name, H = '', L = '';
                    for(q = 0; q < p - 2; ++q)H += (0 !== q ? ', ' : '') + 'arg' + q, L += (0 !== q ? ', ' : '') + 'arg' + q + 'Wired';
                    m = 'return function ' + Ka(m) + '(' + H + ') {\nif (arguments.length !== ' + (p - 2) + ") {\nthrowBindingError('function " + m + " called with ' + arguments.length + ' arguments, expected " + (p - 2) + " args!');\n}\n";
                    B && (m += 'var destructors = [];\n');
            ...
            c: function(a, b, c, d, f) {
                ...
                U(a, {
                    ...
                    toWireType: function(m, n) {
                        if ('number' !== typeof n && 'boolean' !== typeof n) throw new TypeError('Cannot convert "' + Va(n) + '" to ' + this.name);
                        if (n < d || n > f) throw new TypeError('Passing a number "' + Va(n) + '" from JS side to C/C++ side to an argument of type "' + b + '", which is outside the valid range [' + d + ', ' + f + ']!');
                        return k ? n >>> 0 : n | 0;
                    },
                    argPackAdvance: 8,
                    ...
                    toWireType: function(d, f) {
                        ...
                        var l = (c && g ? function() {
                            for(var m = 0, n = 0; n < f.length; ++n){
                                ...
                                127 >= p ? ++m : m = 2047 >= p ? m + 2 : 65535 >= p ? m + 3 : m + 4;
                            }
                            return m;
                        } : function() {
                            return f.length;
            ...
            h: function(a, b, c) {
                ...
                if (2 === b) {
                    ...
                    var h = 1;
                } else 4 === b && (d = sa, f = ta, g = ua, l = function() {
                    return I;
                }, h = 2);
                U(a, {
                    name: c,
                    fromWireType: function(k) {
                        for(var m = I[k >> 2], n = l(), p, x = k + 4, B = 0; B <= m; ++B){
                            var q = k + 4 + B * b;
                            if (B == m || 0 == n[q >> h]) x = d(x, q - x), void 0 === p ? p = x : (p += String.fromCharCode(0), p += x), x = q + b;
                        }
                        X(k);
                        return p;
                    },
            ...
            m: function(a, b, c, d) {
                for(var f = 0, g = 0; g < c; g++){
                    for(var l = E[b + 8 * g >> 2], h = E[b + (8 * g + 4) >> 2], k = 0; k < h; k++){
                        var m = A[l + k], n = pb[a];
                        if (0 === m || 10 === m) {
                            m = 1 === a ? ka : w;
                            var p;
                            for(p = 0; n[p] && !(NaN <= p);)++p;
                            p = ma.decode(n.subarray ? n.subarray(0, p) : new Uint8Array(n.slice(0, p)));
                            m(p);
                            n.length = 0;
                        } else n.push(m);
                    }
        ...
        (function() {
            function a(f) {
                ...
                0 == K && (null !== Ea && (clearInterval(Ea), Ea = null), M && (f = M, M = null, f()));
            }
            function b(f) {
                a(f.instance);
            }
            function c(f) {
                return Promise.resolve().then(Ha).then(function(g) {
