...
var Module = function() {
    ...
    return function(Module1) {
        ...
        var f;
        f || (f = typeof Module1 !== 'undefined' ? Module1 : {
        });
        var aa, ba;
        ...
        var ma = f.print || console.log.bind(console), v = f.printErr || console.warn.bind(console);
        ...
        var A, na = !1, oa = new _textDecoder.TextDecoder('utf8');
        function pa(a, b, c) {
            var d = B;
            if (0 < c) {
                c = b + c - 1;
        ...
        var qa = new _textDecoder.TextDecoder('utf-16le');
        function ra(a, b) {
            var c = a >> 1;
        ...
        function N(a) {
            for(; 0 < a.length;){
                ...
                if ('function' == typeof b) b(f);
                    ...
                    var c = b.R;
                    'number' === typeof c ? void 0 === b.L ? J.get(c)() : J.get(c)(b.L) : c(void 0 === b.L ? null : b.L);
                }
            }
        }
        var O = {
        ...
        function Pa(a, b, c) {
            ...
            b.forEach(function(h, k) {
                R.hasOwnProperty(h) ? e[k] = R[h] : (g.push(h), Q.hasOwnProperty(h) || (Q[h] = []), Q[h].push(function() {
                    e[k] = R[h];
                    ++m;
                    m === g.length && d(e);
                }));
        ...
        function $a(a, b, c) {
            f.hasOwnProperty(a) ? ((void 0 === c || void 0 !== f[a].J && void 0 !== f[a].J[c]) && W("Cannot register public name '" + a + "' twice"), Za(a, a), f.hasOwnProperty(c) && W('Cannot register multiple overloads of a function with the same number of arguments (' + c + ')!'), f[a].J[c] = b) : (f[a] = b, void 0 !== c && (f[a].ba = c));
        }
        function ab(a, b) {
        ...
        function bb(a, b) {
            0 <= a.indexOf('j') || u('Assertion failed: getDynCaller should only be called with i64 sigs');
            var c = [];
            return function() {
                c.length = arguments.length;
                for(var d = 0; d < arguments.length; d++)c[d] = arguments[d];
                var e;
                -1 != a.indexOf('j') ? e = c && c.length ? f['dynCall_' + a].apply(null, [
                    b
                ].concat(c)) : f['dynCall_' + a].call(null, b) : e = J.get(b).apply(null, c);
                return e;
            };
        }
        function Y(a, b) {
        ...
        var tb = {
            ...
            n: function(a) {
                var b = O[a];
                delete O[a];
                var c = b.W, d = b.X, e = b.N, g = e.map(function(m) {
                    return m.U;
                ...
                Pa([
                    ...
                    e.forEach(function(k, n) {
                        var l = m[n], p = k.S, x = k.T, y = m[n + e.length], q = k.Y, ca = k.$;
                        h[k.P] = {
                            read: function(z) {
                    ...
                    return [
                        {
                            ...
                            toWireType: function(k, n) {
                                for(var l in h)if (!(l in n)) throw new TypeError('Missing field:  "' + l + '"');
                                var p = c();
            ...
            g: function(a, b, c, d, e, g) {
                ...
                Pa([], m, function(h) {
                    var k = [
                        h[0],
                        null
                    ].concat(h.slice(1)), n = h = a, l = e, p = k.length;
                    2 > p && W("argTypes array size mismatch! Must at least get return value and 'this' types!");
                    for(var x = null !== k[1] && !1, y = !1, q = 1; q < k.length; ++q)if (null !== k[q] && void 0 === k[q].K) {
                        y = !0;
                        break;
                    }
                    var ca = 'void' !== k[0].name, z = '', E = '';
                    for(q = 0; q < p - 2; ++q)z += (0 !== q ? ', ' : '') + 'arg' + q, E += (0 !== q ? ', ' : '') + 'arg' + q + 'Wired';
                    n = 'return function ' + La(n) + '(' + z + ') {\nif (arguments.length !== ' + (p - 2) + ") {\nthrowBindingError('function " + n + " called with ' + arguments.length + ' arguments, expected " + (p - 2) + " args!');\n}\n";
                    y && (n += 'var destructors = [];\n');
            ...
            d: function(a, b, c, d, e) {
                ...
                U(a, {
                    ...
                    toWireType: function(n, l) {
                        if ('number' !== typeof l && 'boolean' !== typeof l) throw new TypeError('Cannot convert "' + Wa(l) + '" to ' + this.name);
                        if (l < d || l > e) throw new TypeError('Passing a number "' + Wa(l) + '" from JS side to C/C++ side to an argument of type "' + b + '", which is outside the valid range [' + d + ', ' + e + ']!');
                        return k ? l >>> 0 : l | 0;
                    },
                    argPackAdvance: 8,
                    ...
                    toWireType: function(d, e) {
                        ...
                        var m = (c && g ? function() {
                            for(var n = 0, l = 0; l < e.length; ++l){
                                ...
                                55296 <= p && 57343 >= p && (p = 65536 + ((p & 1023) << 10) | e.charCodeAt(++l) & 1023);
                                127 >= p ? ++n : n = 2047 >= p ? n + 2 : 65535 >= p ? n + 3 : n + 4;
                            }
                            return n;
                        } : function() {
                            return e.length;
            ...
            f: function(a, b, c) {
                ...
                if (2 === b) {
                    ...
                    var h = 1;
                } else 4 === b && (d = ua, e = va, g = wa, m = function() {
                    return I;
                }, h = 2);
                U(a, {
                    name: c,
                    fromWireType: function(k) {
                        for(var n = I[k >> 2], l = m(), p, x = k + 4, y = 0; y <= n; ++y){
                            var q = k + 4 + y * b;
                            if (y == n || 0 == l[q >> h]) x = d(x, q - x), void 0 === p ? p = x : (p += String.fromCharCode(0), p += x), x = q + b;
                        }
                        Z(k);
                        return p;
                    },
            ...
            j: function(a, b, c, d) {
                for(var e = 0, g = 0; g < c; g++){
                    for(var m = F[b + 8 * g >> 2], h = F[b + (8 * g + 4) >> 2], k = 0; k < h; k++){
                        var n = B[m + k], l = ob[a];
                        if (0 === n || 10 === n) {
                            n = 1 === a ? ma : v;
                            var p;
                            for(p = 0; l[p] && !(NaN <= p);)++p;
                            p = oa.decode(l.subarray ? l.subarray(0, p) : new Uint8Array(l.slice(0, p)));
                            n(p);
                            l.length = 0;
                        } else l.push(n);
                    }
        ...
        (function() {
            function a(e) {
                ...
                0 == K && (null !== Ga && (clearInterval(Ga), Ga = null), L && (e = L, L = null, e()));
            }
            function b(e) {
                a(e.instance);
            }
            function c(e) {
                return Promise.resolve().then(Ja).then(function(g) {
            ...
            (function() {
                return w || 'function' !== typeof WebAssembly.instantiateStreaming || Ha() || 'function' !== typeof fetch ? c(b) : fetch(M, {
