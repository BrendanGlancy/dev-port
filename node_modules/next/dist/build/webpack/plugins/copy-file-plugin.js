...
class CopyFilePlugin {
    ...
    apply(compiler) {
        compiler.hooks.thisCompilation.tap(PLUGIN_NAME, (compilation)=>{
            const cache = _webpack.isWebpack5 ? compilation.getCache('CopyFilePlugin') : null;
            const hook = _webpack.isWebpack5 ? compilation.hooks.processAssets : compilation.hooks.additionalAssets;
            hook.tapPromise(_webpack.isWebpack5 ? {
                name: PLUGIN_NAME,
