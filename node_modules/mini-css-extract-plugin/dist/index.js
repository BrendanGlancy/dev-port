...
class MiniCssExtractPlugin {
  static getCssModule(webpack) {
    ...
    webpack.util.serialization.register(CssModule, _path.default.resolve(__dirname, "CssModule"), null, {
  ...
  static getCssDependency(webpack) {
    ...
    webpack.util.serialization.register(CssDependency, _path.default.resolve(__dirname, "CssDependency"), null, {
      serialize(instance, context) {
        instance.serialize(context);
      },
